    ...
    <div>
        ...
        <tabs>
            <template v-slot:lista>
                <search placeholder="Buscar Empresa" @searchtext="searchFx($event)"></search>
                ...
                <table class="highlight responsive-table card">
                    ...
                    <tbody>
                        <tr v-for="item in items.lstEmpresaTransportista">
                            <td>{{ item.nombreEmpresa }}</td>
                            <td>{{ item.responsableEmpresa }}</td>
            ...
            <template v-slot:nuevo>
                <div class="row card p-2" style="max-width: 650px;">
                    <h6>Formulario nueva Empresa</h6>
...
export default {
    ...
    methods: {
        ...
        getItems() {
            this.axios({
                method: 'get',
                url: this.api + '/EmpresaTransportista/Get' 
            })
                .then((response) => {
